...
if __name__ == '__main__':
    ...
    if max_rel_tol_nums < len(rel_tols):
        print_warning('Cantilever data corrupted. Showing the first {} only.'.format(max_rel_tol_nums))
    ...
    fig.savefig(folder / 'cantilever.pdf')
    fig.savefig(folder / 'cantilever.png')
    ...
    fig_l_g.savefig(folder / 'cantilever_loss_grad.pdf')
    fig_l_g.savefig(folder / 'cantilever_loss_grad.png')
    plt.show()
